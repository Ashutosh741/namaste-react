        ...
        "restaurants": [
            {
              ...
              "analytics": {
                "context": "seo-data-3ab51c42-6c98-46e7-97e9-73cf3e34ee58"
              },
              "cta": {
            ...
            <div className="row">
                <div className="col-md-3">
                    <div className="res-card">
                        {/* <img className='res-logo' alt = "res-logo" src = {RestaurantList.restaurants.info.cloudinaryImageId}/> */}
                        <h3>{RestaurantList?.restaurants?.info?.name}</h3>
                        <h4>{RestaurantList?.restaurants?.info?.cuisines}</h4>
                        <h4>{RestaurantList?.restaurants?.info?.avgRating}</h4>
                        <h4>{RestaurantList?.restaurants?.info?.costForTwo}</h4>
                        <h4>{RestaurantList?.restaurants?.info?.sla.slaString}</h4>
                        <h4>{RestaurantList?.restaurants?.info?.name}</h4>
                        <h4>{RestaurantList?.restaurants?.info?.name}</h4>
                        <h4>{RestaurantList?.restaurants?.info?.name}</h4>
